    ...
    return (
        <div className="p-4 sm:p-6 lg:p-8 max-w-4xl mx-auto space-y-6">
            <div>
                ...
                <p className="text-muted-foreground">Genera el reporte diario de operaciones para la guardia activa.</p>
            </div>
            ...
            <Card className="shadow-lg">
                <CardHeader>
                    ...
                    <CardDescription>
                        Selecciona una guardia para generar su reporte. Esta selección definirá la guardia activa para el reporte de cierre.
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <div className="space-y-4">
                        <div className="space-y-2 max-w-xs">
                            <Label htmlFor="guard-select" className="text-xs uppercase font-bold text-muted-foreground">Guardia Activa Actual</Label>
                        ...
                        {selectedGuardId ? (
                            ...
                            <div className="text-center py-12 border-2 border-dashed rounded-lg bg-muted/30">
                                <p className="text-muted-foreground">Por favor, selecciona una guardia para empezar.</p>
                                {guards.length === 0 && (
                                    <p className="text-xs mt-2">
                                        No hay guardias definidas. Ve a <Link href="/personal" className="text-primary font-bold hover:underline">Gestión de Personal</Link> para crearlas.
                                    </p>
                                )}
                            </div>
                        )}
