        ...
        <div className="p-4 sm:p-6 lg:p-8">
            <Card className="max-w-5xl mx-auto shadow-lg">
                <CardHeader>
                    ...
                    <CardDescription>
                        Reportes de cierre generados y guardados anteriormente.
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    {!isLoaded ? (
                            ...
                            {sortedReports.map((report) => (
                                ...
                                >
                                    ...
                                    <div className="flex gap-2 w-full sm:w-auto">
                                        <Button variant="outline" size="sm" className="flex-1 sm:flex-none" onClick={() => handleView(report.id)}>
                                        ...
                                        <AlertDialog>
                                            ...
                                            <AlertDialogContent>
                                                <AlertDialogHeader>
                                                    ...
                                                    <AlertDialogDescription>
                                                        Esta acción no se puede deshacer. El reporte se borrará permanentemente del historial de este dispositivo.
                                                    </AlertDialogDescription>
                                                </AlertDialogHeader>
                                                <AlertDialogFooter>
            ...
            <Dialog open={viewDialogOpen} onOpenChange={setViewDialogOpen}>
                <DialogContent className="max-h-[90vh] max-w-[90vw] sm:max-w-3xl flex flex-col">
                    ...
                    <DialogFooter>
                        <Button onClick={() => navigator.clipboard.writeText(selectedReport?.content || '')} variant="outline">
