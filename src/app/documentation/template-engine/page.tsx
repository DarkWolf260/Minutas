...
export default function TemplateEnginePage() {
                    ...
                    <Card className="shadow-lg">
                        ...
                        <CardContent className="space-y-12 pt-6">
                            <Alert>
                                ...
                                <AlertDescription>
                                    El motor de plantillas ahora soporta operadores lógicos avanzados, modificadores de texto encadenados y formatos personalizados. Consulta la sección de <a href="#advanced-features" className="text-primary underline">Funcionalidades Avanzadas</a>.
                                </AlertDescription>
                            </Alert>
                            ...
                            >
                                ...
                                <p className="text-muted-foreground leading-relaxed mt-2">
                                    Este sistema permite una alta flexibilidad, ya que los usuarios pueden definir no solo los campos de un reporte, sino también la estructura del formulario (secciones, campos repetibles, lógica condicional avanzada) directamente desde un archivo de texto simple.
                                </p>
                            </DocSection>
                            ...
                            >
                                <div>
                                    ...
                                    <p className="text-muted-foreground leading-relaxed">
                                        El primer paso es el análisis. La función <Code>parseTemplate</Code> lee el contenido de la plantilla y lo descompone en una estructura de datos que la aplicación puede entender. Esta estructura se conoce como <Code>TemplateParserResult</Code> y contiene:
                                    </p>
                                    <ul className="list-disc list-inside mt-2 space-y-1 text-muted-foreground pl-4">
                                        <li><Code>fieldNames</Code>: Un Set con todos los nombres de campo únicos encontrados.</li>
                                        <li><Code>fieldTypes</Code>: Un Map que asocia cada campo con su tipo (text, textarea, date, dropdown, etc.).</li>
                                        <li><Code>sections</Code>: Un array que define cada sección estructural de la plantilla.</li>
                                        <li><Code>layout</Code>: Un array que mantiene el orden original de todos los elementos.</li>
                                        <li><Code>templateOptions</Code>: Map con las opciones de los campos dropdown.</li>
                                        <li><Code>fieldModifiers</Code>: Map con los modificadores de texto para cada campo.</li>
                                        <li><Code>errors</Code>: Array con errores de sintaxis o semántica detectados.</li>
                                    </ul>
                                </div>
                                <div>
                            ...
                            >
                                <div>
                                    ...
                                    <ul className="list-disc list-inside mt-3 space-y-2 text-muted-foreground pl-4">
                                        ...
                                        <li><strong>Retorna:</strong> Un objeto <Code>TemplateParserResult</Code> con la siguiente estructura:
                                            <CodeBlock>
                                                {`{
  ...
  errors: string[]
                                        ...
                                        <li><strong>Validaciones:</strong> Detecta automáticamente:
                                            <ul className="list-disc list-inside pl-6">
                                                <li>Llaves <Code>{`{}`}</Code> desbalanceadas</li>
                                                <li>Corchetes <Code>[]</Code> desbalanceados</li>
                                                <li>Condicionales sin cerrar <Code>[?...] sin [/]</Code></li>
                                    ...
                                    <ul className="list-disc list-inside mt-3 space-y-2 text-muted-foreground pl-4">
                                        ...
                                        <li><strong>Parámetros Principales:</strong>
                                            <ul className="list-disc list-inside pl-6">
                                                ...
                                                <li><Code>predefinedValues</Code>: Valores predefinidos del sistema.</li>
                                        ...
                                        <li><strong>Lógica Clave:</strong>
                                            <ol className="list-decimal list-inside pl-6 mt-2">
                                                <li>Primero, llama a <Code>renderContentWithSections</Code> para obtener el reporte completamente renderizado.</li>
                                                <li>Si <Code>summaryOnly</Code> es <Code>true</Code>, extrae el contenido entre <Code>{'<<'}...{'>>'}</Code> del resultado anterior.</li>
                                                <li>Aplica modificadores de texto (upper, lower, title, format, default).</li>
                            ...
                            >
                                        ...
                                        <li><strong>Lógica Clave:</strong>
                                            <ol className="list-decimal list-inside pl-6 mt-2">
                                                <li>Utiliza una expresión regular (<Code>blockRegex</Code>) compleja para encontrar el siguiente bloque de interés. Esta regex busca, en orden de prioridad:
                                                    <ul className="list-disc list-inside pl-6">
                                                        <li>Bloques condicionales avanzados: <Code>[?{'{...}'} op valor]...[/]</Code> donde <Code>op</Code> puede ser <Code>=</Code>, <Code>!=</Code>, <Code>{'>'}</Code>, <Code>{'<'}</Code>, <Code>{'>='}</Code>, <Code>{'<='}</Code></li>
                                                        <li>Bloques de sección estándar: <Code>[...]</Code> o <Code>[...]*</Code></li>
                                                        <li>Etiquetas de campo: <Code>{'{...}'}</Code></li>
                                                    </ul>
                                                </li>
                                                <li>Para cada bloque encontrado, determina su tipo y extrae la información relevante (ej. el campo, operador y valor de una condición).</li>
                                ...
                                <div>
                                    <h3 className="font-semibold text-lg mb-2"><Code>evaluateCondition(fieldValue, operator, targetValue)</Code></h3>
                                    <p className="text-muted-foreground leading-relaxed">
                                        Evalúa una condición usando el operador especificado. Soporta comparaciones numéricas y de strings.
                                    </p>
                                    <ul className="list-disc list-inside mt-3 space-y-2 text-muted-foreground pl-4">
                                        <li><strong>Operadores Soportados:</strong> <Code>=</Code>, <Code>!=</Code>, <Code>{'>'}</Code>, <Code>{'<'}</Code>, <Code>{'>='}</Code>, <Code>{'<='}</Code></li>
                                        <li><strong>Lógica:</strong> Si ambos valores son numéricos, compara como números. De lo contrario, compara como strings.</li>
                                    </ul>
                                </div>
                                <div>
                                    <h3 className="font-semibold text-lg mb-2"><Code>applyTextModifier(value, modifier)</Code></h3>
                                    <p className="text-muted-foreground leading-relaxed">
                                        Aplica modificadores de texto de forma encadenada a un valor.
                                    </p>
                                    <ul className="list-disc list-inside mt-3 space-y-2 text-muted-foreground pl-4">
                                        <li><strong>Modificadores Soportados:</strong>
                                            <ul className="list-disc list-inside pl-6">
                                                <li><Code>upper</Code>: Convierte a MAYÚSCULAS</li>
                                                <li><Code>lower</Code>: Convierte a minúsculas</li>
                                                <li><Code>title</Code>: Convierte A Título (Primera Letra Mayúscula)</li>
                                                <li><Code>format("formatString")</Code>: Formatea fechas usando el patrón especificado</li>
                                                <li><Code>default("valor")</Code>: Proporciona un valor por defecto si el campo está vacío</li>
                                            </ul>
                                        </li>
                                        <li><strong>Encadenamiento:</strong> Los modificadores pueden encadenarse usando <Code>|</Code>, por ejemplo: <Code>{'{Campo|upper|default("N/A")}'}</Code></li>
                                    </ul>
                                </div>
                                <div>
                            ...
                            >
                                <ul className="list-disc list-inside mt-3 space-y-4 text-muted-foreground pl-4">
                                    ...
                                    <li><strong>Campos con Modificadores:</strong> <Code>{'{Nombre|upper}'}</Code>, <Code>{'{Fecha|format("dd-MM-yyyy")}'}</Code></li>
                                    <li><strong>Modificadores Encadenados:</strong> <Code>{'{Campo|lower|default("sin datos")}'}</Code></li>
                                    ...
                                    <li><strong>Condicionales Simples:</strong> <Code>[?{'{CampoDropdown}'}=0] ... [/]</Code></li>
                                    <li><strong>Condicionales Avanzados:</strong>
                                        <ul className="list-disc list-inside pl-6 mt-1">
                                            <li><Code>[?{`{Campo} != valor`}] ... [/]</Code> (Diferente de)</li>
                                            <li><Code>[?{`{Numero} > 10`}] ... [/]</Code> (Mayor que)</li>
                                            <li><Code>[?{`{Numero} < 100`}] ... [/]</Code> (Menor que)</li>
                                            <li><Code>[?{`{Edad} >= 18`}] ... [/]</Code> (Mayor o igual)</li>
                                            <li><Code>[?{`{Cantidad} <= 5`}] ... [/]</Code> (Menor o igual)</li>
                                        </ul>
                                    </li>
                            ...
                            >
                                <div>
                                    ...
                                    <p className="text-muted-foreground leading-relaxed">
                                        Los condicionales ahora soportan operadores avanzados para comparaciones más complejas:
                                    </p>
                                    <ul className="list-disc list-inside mt-2 space-y-1 text-muted-foreground pl-4">
                                        <li><Code>=</Code> : Igual a (por defecto, retrocompatible)</li>
                                        <li><Code>!=</Code> : Diferente de</li>
                                        <li><Code>{'>'}</Code> : Mayor que (numérico o lexicográfico)</li>
                                        <li><Code>{'<'}</Code> : Menor que (numérico o lexicográfico)</li>
                                        <li><Code>{'>='}</Code> : Mayor o igual que</li>
                                        <li><Code>{'<='}</Code> : Menor o igual que</li>
                                    </ul>
                                    <p className="text-muted-foreground leading-relaxed mt-2">
                                        <strong>Nota:</strong> Si ambos valores pueden interpretarse como números, la comparación es numérica. De lo contrario, es lexicográfica (alfabética).
                                    </p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p className="text-muted-foreground leading-relaxed">
                                        Puedes aplicar múltiples transformaciones a un campo usando el operador <Code>|</Code>:
                                    </p>
                                    <CodeBlock>
...
{Campo|upper|default("NINGUNO")}  → Si está vacío: NINGUNO`}
                                ...
                                <div>
                                    ...
                                    <p className="text-muted-foreground leading-relaxed">
                                        Usa el modificador <Code>format("patrón")</Code> para personalizar cómo se muestran las fechas:
                                    </p>
                                    <CodeBlock>
...
{FechaHora|format("dd/MM/yyyy HH:mm")} → 28/12/2025 14:30`}
                                    ...
                                    <p className="text-muted-foreground leading-relaxed mt-2">
                                        La función utiliza la librería <Code>date-fns</Code> con locale español. Consulta la <a href="https://date-fns.org/docs/format" target="_blank" rel="noopener noreferrer" className="text-primary underline">documentación de date-fns</a> para más patrones.
                                    </p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p className="text-muted-foreground leading-relaxed">
                                        Usa <Code>default("valor")</Code> para mostrar un texto alternativo cuando un campo está vacío:
                                    </p>
                                    <CodeBlock>
...
{Comentarios|default("N/A")|upper}  → N/A si está vacío`}
                            ...
                            >
                                <div>
                                    <h3 className="font-semibold text-lg mb-2">Ejemplo 1: Reporte de Incidentes con Prioridad</h3>
                                    <CodeBlock>
...
[/]`}
                                ...
                                <div>
                                    <h3 className="font-semibold text-lg mb-2">Ejemplo 3: Secciones Repetibles con Formato</h3>
                                    <CodeBlock>
