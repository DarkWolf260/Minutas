        ...
        <Card className="shadow-lg">
          ...
          <CardContent className="space-y-6 pt-6 text-center">
            <div className="text-muted-foreground space-y-4 leading-relaxed">
              <p>
                Esta aplicación fue diseñada y desarrollada con el objetivo de simplificar y
                agilizar la creación de reportes operativos. La meta es proporcionar una herramienta
                robusta, flexible y fácil de usar que se adapte a las necesidades del trabajo
                diario.
              </p>
              <p>
                Toda la información que ingresas se almacena de forma segura y privada en tu propio
                navegador usando una base de datos local avanzada (**RxDB**), garantizando que tus
                datos permanezcan bajo tu control y funcionen incluso sin internet.
              </p>
            ...
            <div className="space-y-4">
              ...
              <blockquote className="border-l-4 pl-4 italic text-muted-foreground text-left">
                <p>
                  ...
                  el que ni me molesté en revisar su sintaxis. Todo esto usando el tiempo en el que
                  debí estar haciendo mi tesis. Gracias Git, por permitirme volver atrás cada que
                  rompía el código"
                </p>
              </blockquote>
              <p className="text-sm italic text-muted-foreground text-center pt-2">
                PD: "Ya logré convertir esta vaina en una PWA y meterle una base de datos de verdad.
                Ahora, ¿dónde está mi café?"
              </p>
            </div>
          </CardContent>
        </Card>
