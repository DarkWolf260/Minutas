...
export function CedulaInput({ value: propValue, onChange: onFormChange, disabled = false, ...props }: { value: string; onChange: (value: string) => void; disabled?: boolean; [key: string]: any; }) {
