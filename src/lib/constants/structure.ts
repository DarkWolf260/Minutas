...
export const DEFAULT_DEPARTMENTS: Department[] = [
  ...
  { id: DEPARTMENT_IDS.CEMUPRAD, name: DEPARTMENT_NAMES.CEMUPRAD, staff: {}, order: 1 },
  { id: DEPARTMENT_IDS.EDUCATION, name: DEPARTMENT_NAMES.EDUCATION, staff: {}, order: 2 },
  { id: DEPARTMENT_IDS.RISKS, name: DEPARTMENT_NAMES.RISKS, staff: {}, order: 3 },
  { id: DEPARTMENT_IDS.IT, name: DEPARTMENT_NAMES.IT, staff: {}, order: 4 },
  { id: DEPARTMENT_IDS.LOGISTICS, name: DEPARTMENT_NAMES.LOGISTICS, staff: {}, order: 5 },
];
